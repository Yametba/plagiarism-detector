    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('default_plagiarism_threshold_allowed') ? 'is-invalid' : '' }}" type="number" name="default_plagiarism_threshold_allowed" id="default_plagiarism_threshold_allowed" value="{{ old('default_plagiarism_threshold_allowed', '25') }}" step="1" required>
