    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.folders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('plagiarism_threshold_allowed') ? 'is-invalid' : '' }}" type="number" name="plagiarism_threshold_allowed" id="plagiarism_threshold_allowed" value="{{ old('plagiarism_threshold_allowed', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('automatic_analysis') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="automatic_analysis" id="automatic_analysis" value="1" {{ old('automatic_analysis', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('allowed_public_access') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="allowed_public_access" id="allowed_public_access" value="1" {{ old('allowed_public_access', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('allowed_users') ? 'is-invalid' : '' }}" name="allowed_users" id="allowed_users">{{ old('allowed_users') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('submitter_email') ? 'is-invalid' : '' }}" type="email" name="submitter_email" id="submitter_email" value="{{ old('submitter_email') }}" required>
