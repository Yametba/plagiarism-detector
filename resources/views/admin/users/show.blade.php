...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#owner_workspaces" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="owner_workspaces">
            @includeIf('admin.users.relationships.ownerWorkspaces', ['workspaces' => $user->ownerWorkspaces])
        </div>
