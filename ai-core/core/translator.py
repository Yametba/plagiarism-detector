...
def translate_text(text, text_lang='fr', target_lang='en') -> str:
    # Vérification que le texte d'entrée n'est pas vide
    if not text:
        return text
    try:
        ...
        # Gestion de l'erreur de détection de la langue
        return text
